...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<XpoClassGeneratorBlazorApplication>();
            ...
            builder.Modules
            	...
            	.Add<XpoClassGeneratorBlazorModule>();
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "XpoClassGenerator API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the XpoClassGenerator.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
            });
        });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "XpoClassGenerator WebApi v1");
            });
        }
        else {
